...
namespace OrdinatioVitae.Api.Migrations.Application
{
    ...
    [Migration("20260105104446_Add_Habits")]
...
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("ordinatio_vitae")
                .HasAnnotation("ProductVersion", "9.0.1")
                .HasAnnotation("Relational:MaxIdentifierLength", 63);

            NpgsqlModelBuilderExtensions.UseIdentityByDefaultColumns(modelBuilder);

            modelBuilder.Entity("OrdinatioVitae.Api.Entities.Habit", b =>
                {
                    ...
                    b.ToTable("habits", "ordinatio_vitae");
                });

            modelBuilder.Entity("OrdinatioVitae.Api.Entities.Habit", b =>
                {
                    b.OwnsOne("OrdinatioVitae.Api.Entities.Frequency", "Frequency", b1 =>
                        {
                            ...
                            b1.ToTable("habits", "ordinatio_vitae");
                    ...
                    b.OwnsOne("OrdinatioVitae.Api.Entities.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("OrdinatioVitae.Api.Entities.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
